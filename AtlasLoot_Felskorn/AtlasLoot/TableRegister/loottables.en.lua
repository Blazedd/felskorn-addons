...
-------------------------
  ...
  -- Zul'Gurub
	AtlasLoot_TableNames["ZGJeklik"] = { "High Priestess Jeklik", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["ZGVenoxis"] = { "High Priest Venoxis", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["ZGMarli"] = { "High Priestess Mar'li", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["ZGMandokir"] = { "Bloodlord Mandokir", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["ZGDino"] = { "Durza the Shadowing", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["ZGGahzranka"] = { "Gahz'ranka", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["ZGLordZath"] = { "Lord Zath", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["ZGArlokk"] = { "High Priestess Arlokk", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["ZGJindo"] = { "Jin'do the Hexxer", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["ZGHakkar"] = { "Hakkar", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["ZGMuddyChurningWaters"] = { "Muddy Churning Waters", "AtlasLootOriginalWoW" };
	AtlasLoot_TableNames["ZGShared"] = { "ZG Vendor Items", "AtlasLootOriginalWoW" };
	...
	AtlasLoot_TableNames["ZGEnchants"] = { "ZG Profession Items", "AtlasLootOriginalWoW" };
...
-------------
  ...
  -- Scarlet Monastery HC
	AtlasLoot_TableNames["SMHVishas"] = { "Vishas", "AtlasLootFelskorn" };
	AtlasLoot_TableNames["SMHThalnos"] = { "Thalnos", "AtlasLootFelskorn" };
	AtlasLoot_TableNames["SMHLoksey"] = { "Loksey", "AtlasLootFelskorn" };
	AtlasLoot_TableNames["SMHDoan"] = { "Doan", "AtlasLootFelskorn" };
	AtlasLoot_TableNames["SMHBilly"] = { "Billy", "AtlasLootFelskorn" };
	AtlasLoot_TableNames["SMHHerod"] = { "Herod", "AtlasLootFelskorn" };
	AtlasLoot_TableNames["SMHMograine"] = { "Mograine", "AtlasLootFelskorn" };
	AtlasLoot_TableNames["SMHWhitemane"] = { "Whitemane", "AtlasLootFelskorn" };
	AtlasLoot_TableNames["SMHTrash"] = { "Trash", "AtlasLootFelskorn" };
