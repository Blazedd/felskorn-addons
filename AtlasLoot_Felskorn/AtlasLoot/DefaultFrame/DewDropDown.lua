...
AtlasLoot_DewDropDown = {
	...
	[4] = {
		["Felskorn"] = {
			[1] = {
				 { BabbleZone["Scarlet Monastery"], "ScarleMonasteryHC", "Submenu" },
			},
		},
	},
	[5] = {
...
AtlasLoot_DewDropDown_SubTables = {
	...
	["ZulGurub"] = {
		...
		{ "Durza the Shadowing", "ZGDino" },
		{ "Gahz'ranka", "ZGGahzranka" },
		{ "Lord Zath", "ZGLordZath" },
		{ "Jin'do the Hexxer", "ZGJindo" },
		{ "High Priestess Arlokk", "ZGArlokk" },
		{ "Hakkar", "ZGHakkar" },
		{ "ZG Vendor Items", "ZGShared" },
		{ "Trash Mobs", "ZGTrash1" },
		{ "ZG Profession Items", "ZGEnchants" },
	},
	["CoTOldHillsbrad"] = {
		{ "", "CoTHillsbradDrake" },
		{ "", "CoTHillsbradSkarloc" },
